...
//  CMPT275
//
//  Created by Christopher Le, Greyson Wang on 2016-10-30.
//  Copyright © 2016 Christopher Le. All rights reserved.
//
/*
Version 1: adding GoogleMapAPI and FireBaseAPI functions
Authors: Christopher Le, Mohammed Shakoory, Aaron Guo
*/
/*
CMPT 275
GROUP 7
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //Initializes Google Map API services
        GMSServices.provideAPIKey("AIzaSyBtdsqiRotWed5UFhC6T8XEeGnpuhVq3Eo")
...
/*
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "CMPT275")
